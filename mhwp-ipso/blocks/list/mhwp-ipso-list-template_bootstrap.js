    ...
    return `
           <li class="activity list-group-item list-group-item-${light_dark }">
            <div class="row lead">
                ...
                <div class="col-md-4">
                    <button class="pull-right btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseDetail_${cnt}" aria-expanded="false" aria-controls="collapseExample">
                        Lees meer
                    </button>
            ...
            <div class="collapse detail" id="collapseDetail_${cnt}">
                ${activity.img ? activity.img : ''}
